...
const Switch = ({
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "bg-foreground pointer-events-none block h-5 w-5 rounded-full border border-transparent ring-0 shadow-lg transition-transform data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0",
      )}
    />
  </SwitchPrimitives.Root>
);
